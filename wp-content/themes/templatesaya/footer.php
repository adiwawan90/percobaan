...
<div id="extra-wrap"><div id="extra" class="clearfix">
	    ...
	    <div id="gallery" class="clearfix">
		    ...
		    <p class="thumbs">
			<a href="index.html"><img src="<?php bloginfo('template_url');?>/images/thumb.png" width="42" height="43" alt="thumbnail" /></a>
			<a href="index.html"><img src="<?php bloginfo('template_url');?>/images/thumb.png" width="42" height="43" alt="thumbnail" /></a>
			<a href="index.html"><img src="<?php bloginfo('template_url');?>/images/thumb.png" width="42" height="43" alt="thumbnail" /></a>
			<a href="index.html"><img src="<?php bloginfo('template_url');?>/images/thumb.png" width="42" height="43" alt="thumbnail" /></a>
			<a href="index.html"><img src="<?php bloginfo('template_url');?>/images/thumb.png" width="42" height="43" alt="thumbnail" /></a>
	    ...
	    <div class="col first">
            ...
            <ul class="subscribe-stuff">
				...
				<img alt="RSS" title="RSS" src="<?php bloginfo('template_url');?>/images/social_rss.png" /></a>
			    </li>
      	        <li><a title="Facebook" href="index.html" rel="nofollow">
				<img alt="Facebook" title="Facebook" src="<?php bloginfo('template_url');?>/images/social_facebook.png" /></a>
			    </li>
			    <li><a title="Twitter" href="index.html" rel="nofollow">
				<img alt="Twitter" title="Twitter" src="<?php bloginfo('template_url');?>/images/social_twitter.png" /></a>
			    </li>
			    <li><a title="E-mail this story to a friend!" href="index.html" rel="nofollow">
				<img alt="E-mail this story to a friend!" title="E-mail this story to a friend!" src="<?php bloginfo('template_url');?>/images/social_email.png" /></a>
			    </li>
            </ul>
...
<footer>
	...
	<p class="footer-left">
		&copy; <?php echo date ("Y"); ?> Copyright Design by <a href= "<?php bloginfo('home'); ?>"><?php echo date("Y"); echo " "; bloginfo('name'); ?></a>
	</p>	
